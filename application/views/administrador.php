   ...
   $('#procesar').on('click', function(e){
      ...
      if(!fecha){
        ...
        if (!ruta) {
          ...
          $.ajax({
          type: 'post',
          url: '<?php echo base_url("index.php/administrador/procesar"); ?>',
          cache: false,
          data: {
            pedidos,
            ruta,
...
// function permitirAcceso (rif) {
//     var codigo = $("#codigo_" + rif + "").val();
//     if (codigo == null || codigo == "") {
//       alert("Debe introducir un codigo")
//     }else{
//       if (confirm('¿ Realmente desea autorizar a este usuario?')) {
//         $.ajax({
//           type: 'post',
//           url: '<?php echo base_url("index.php/sesiones/authUser"); ?>',
//           cache: false,
//           data: {
//             rif: rif,
//             codigo: codigo
